...
all_data = pd.read_csv("PCA_half/Random_First_Half_same_twarze_faces_data_network_OK_CASIA-WebFace_align.txt")
...
all_data2 = pd.read_csv("PCA_half/Random_Second_Half_same_twarze_faces_data_network_OK_CASIA-WebFace_align.txt")
