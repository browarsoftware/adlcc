...
cluster_file_name = "AgglomerativeClustering_16_Random_First_Half_same_twarze_faces_data_network_OK_CASIA-WebFace_align.txt.csv"
...
model.save("Supervised/NN_" + str(neurons_count) + "_" + train_file_name + ".mod")



file_name_res = "NN_" + str(neurons_count) + train_file_name + "_.csv"
...
file_name_res = "SVM_" + train_file_name + "_.csv"
filename = 'Supervised/LinearSVC_HALF_DATA_TEST.sav'
