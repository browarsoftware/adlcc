...
for distance_threshold in [36, 38]:
    ...
    compareAB(all_data_to_cluster.iloc[:, 2], clustering.labels_)


'''
adjusted_rand_score 0.2972959279251355
homogeneity_score 0.9464820010681485
completeness_score 0.8009109754123169
v_measure_score 0.8676329055786002
fowlkes_mallows_score 0.39999426933390336
'''
